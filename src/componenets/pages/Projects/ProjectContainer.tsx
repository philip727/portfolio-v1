...
export default function ProjectContainer({ name, id, description, image, index, tags }: Props): JSX.Element {
    ...
    return (
        <AnimatePresence key={index}>
            <motion.div 
                ...
                key={index}
            >
                <div key={0} className="absolute bg-no-repeat bg-cover bg-center w-a-lot h-96 rounded-lg" style={{ backgroundImage:`url(${image})`}} />
