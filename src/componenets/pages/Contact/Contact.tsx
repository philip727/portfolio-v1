...
export default function Contact() {
    ...
    return (
        <div className="flex justify-center items-center w-screen h-screen">
            <form className="styled-background styled-border border-2 rounded-2xl w-136 material-shadow flex justify-start flex-col items-center py-6">
                <div className="">
                    <input
                        type="text"
                        name="name"
                ...
                <div className="w-full px-6">
                    <button onSubmit={() => {onSubmit()}} type="submit" name="submit" className="h-16 mt-6 w-fit px-4 darkish-background rounded-md flex items-center gap-4 button transition-shadow transition-color duration-300">
